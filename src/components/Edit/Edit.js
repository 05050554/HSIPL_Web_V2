...
const item = [
  ...
  { name: "Senior Students", value: "5" },
  { name: "Junior Students", value: "6" },
  { name: "Alumnus", value: "7" },
  { name: "Professor Education", value: "8" },
  { name: "Professor Research Experience", value: "9" },
  { name: "Professor Journal Articles", value: "10" },
  { name: "Professor Talks", value: "11" },
  { name: "Professor Service", value: "12" },
  { name: "Professor Conference", value: "13" },
  { name: "Professor Awards", value: "14" },
  { name: "Professor Research Posters", value: "15" },
  { name: "Grant Support and Projects", value: "16" },
  { name: "Equipment", value: "17" },
];
